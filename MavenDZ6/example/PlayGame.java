...
public class PlayGame {
    ...
    public void startGame() {
        ...
        double switchMean = (double) switchWins / TOTAL_GAMES;
        double noSwitchMean = (double) noSwitchWins / TOTAL_GAMES;
        ...
        System.out.println("Среднее значение выигрышей с повторным выбором: " + switchMean);
        System.out.println("Среднее значение выигрышей без повторного выбора: " + noSwitchMean);
